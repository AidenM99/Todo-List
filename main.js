...
function updateWeekProjects(projectName) {
  ...
  todoList.getProject("Week").setTasks(todoList.getProject(projectName).getTasks().filter(function (task) {
    return (0,_UI__WEBPACK_IMPORTED_MODULE_0__.checkWeek)(task);
  }));
  saveTodoList(todoList);
  return todoList;
}
...
function checkWeek(task) {
  ...
  var week = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(task.clearFormattedDate()), {
    weekStartsOn: 1
  });
  return week;
}
